...
class FilterFacesNode:
  ...
  def filter_images(self,images:torch.Tensor,min_face_size:int,prob_threshold:float):
    #Saving Images
    ...
    try:
      gm=fr_instance.filter_images_without_face(output_dir=tmp_path_save,min_face_size=min_face_size,prob_threshold=prob_threshold)
